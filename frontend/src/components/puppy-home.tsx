  ...
  async function act(action: string, extra: Record<string, unknown> = {}) {
    ...
    try {
      ...
      if (action === "ask" || action === "promote") {
        ...
        setAnimation(result.success ? "bouncing" : "wiggling");
      }
      return result;
