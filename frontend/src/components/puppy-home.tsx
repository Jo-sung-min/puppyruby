...
const nav = [{ id: "home", label: "우리 집", icon: Home }, { id: "walk", label: "산책시키기", icon: Footprints }, { id: "adopt", label: "새 가족 만나기", icon: PawPrint }, { id: "closet", label: "옷장", icon: Shirt }, { id: "collection", label: "강아지 도감", icon: BookHeart }] as const;
