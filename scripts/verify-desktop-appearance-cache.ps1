...
foreach ($source in @('DesktopAppearanceCacheTest.cs', 'DesktopAppearanceCache.cs', 'DesktopAppearanceFrames.cs', 'DesktopAppearanceReactions.cs', 'DesktopBreedCatalog.cs', 'DesktopSync.cs', 'Progression.cs', 'PetState.cs')) {
